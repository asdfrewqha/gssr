    ...
    "paths": {
        ...
        "/leaderboard": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "elo or xp (default: elo)",
                        "name": "type",
                        "in": "query"
                    },
                    {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/maps.mapDetail"
                        }
                    },
                    "404": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/room.RoomState"
                        }
                    },
                    "404": {
                        "description": "Not Found",
        ...
        "/rooms/{id}/guess": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Guess coordinates",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/room.guessReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/solo/start": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Map, difficulty, rounds",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/solo.startReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/solo/{id}/guess": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Guess coordinates (normalized 0-1)",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/solo.guessReq"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "maps.mapDetail": {
            ...
            "properties": {
                ...
                "floors": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/maps.floorItem"
                    }
                },
                "id": {
                    "type": "string"
        ...
        "room.RoomState": {
            ...
            "properties": {
                ...
                "guesses": {
                    "description": "Guesses maps userID → guess for the current round.",
                    "type": "object",
                    "additionalProperties": {
                        "$ref": "#/definitions/room.Guess"
                    }
                },
                "host_id": {
                    "type": "string"
                ...
                "players": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/room.Player"
                    }
                },
                "round_token": {
                    "description": "RoundToken is regenerated each round to prevent double-advance races.",
                    "type": "string"
                },
                "rounds": {
                    "type": "integer"
                ...
                "status": {
                    "description": "waiting|active|finished",
                    "type": "string"
                },
                "time_limit_sec": {
                    "type": "integer"
